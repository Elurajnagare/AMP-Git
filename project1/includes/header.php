...
<head>
     ...
     <meta property="og:description" content="{% if doc.description %}{{doc.description}} – {% endif %}Eluminous Technologies Pvt Ltd">
...
<header id="header">
  <div class="container-fluid">
    <div class="container">
      <div class="row">
        <div id="header-top" class="w-100 justify-content-end">
          <div class="w100 d-flex intro">
            <div class="col-lg-6 col-md-6 col-sm-12 offset-lg-6 offset-md-6 p-0 d-flex justify-content-end">
              <div class="d-inline-flex phone-tel mr-4"><a class="mt-2" href="tel:+912532382566"><i class="fa fa-phone"></i>+91 253 238 2566</a></div>
              <div class="d-inline-flex align-content-around mr-3 pl-4 social"><a class="social-links fb" href="https://www.facebook.com/eluminoustech" target="_blank"><i class="fa fa-facebook"></i></a><a class="social-links pn" href="http://www.pinterest.com/eluminoustech/" target="_blank"><i class="fa fa-pinterest"></i></a><a class="social-links tw" href="https://twitter.com/eluminousTech" target="_blank"><i class="fa fa-twitter"></i></a><a class="social-links yt" href="https://www.youtube.com/channel/UCfqg8756psg4hflU027Iu9g" target="_blank"><i class="fa fa-youtube"></i></a></div>
            </div>
          </div>
          <div class="clearfix"></div>
        </div>
        <div class="clearfix"></div>
        <div class="w-100 justify-content-end logo-menu">
          <div id="logo" class="pull-left"> <a href="index.php"><amp-img width="269" height="52" src="images/logo-eluminous-technologies.png" alt="Eluminous Technologies" title="Eluminous Technologies"></amp-img></a> </div>
          <div class="d-flex justify-content-end main-menu">
            <nav id="nav-menu-container" class="d-inline-flex">
              <ul class="nav-menu">
            ...
            <div class="d-inline-flex pull-right morebox"><i class="fa fa-navicon"></i></div>
          </div>
        </div>
        <div class="clearfix"></div>
      </div>
